...
#                 star_pattern += 1
#
#     return (10*dead_enemy) - (0.5*edge) - (20*dead_player) + 2*middle + liberty + (1.5*star_pattern)
def evaluate(player,enemy):
    liberty = 0
    dead_enemy = 0
    edge = 0
    ...
    return (100*dead_enemy) - (edge) - (20*dead_player) + middle + liberty + star_pattern + enemy_edge - middle_enemy - enemy_liberty + star_pattern_at_edge
